...
[![.NET 9 Selenium Tests + Release](https://github.com/LFSoto/Pruebas-.NET/actions/workflows/dotnet-tests.yml/badge.svg)](https://github.com/LFSoto/Pruebas-.NET/actions/workflows/dotnet-tests.yml)
